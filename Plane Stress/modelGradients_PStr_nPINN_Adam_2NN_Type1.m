...
function [gradientsU,gradientsV,loss,lossF,lossUNxx,lossUNyy] = modelGradients_PStr_nPINN_Adam_2NN_Type1(parametersU,parametersV,...
    dlX,dlY,dlX0BCx1,dlY0BCx1,dlU0BCx1,dlX0BCy1,dlY0BCy1,dlU0BCy1,dlX0Nxx,dlY0Nxx,dlU0Nxx,dlX0Nyy,dlY0Nyy,dlU0Nyy,a,b,muy,E,...
    scaleX,scaleY,scaleU,scaleV,alpha_u,alpha_v)

% Make predictions.
U = model_PStr_2NN_U(parametersU,dlX,dlY);
...
% Calculate derivatives of v with respect to X.
V = model_PStr_2NN_V(parametersV,dlX,dlY);
...
dlU0ICxPred = model_PStr_2NN_U(parametersU,dlX0Nxx,dlY0Nxx);
dlV0ICxPred = model_PStr_2NN_V(parametersV,dlX0Nxx,dlY0Nxx);
...
dlU0ICyPred = model_PStr_2NN_U(parametersU,dlX0Nyy,dlY0Nyy);
dlV0ICyPred = model_PStr_2NN_V(parametersV,dlX0Nyy,dlY0Nyy);
