function [loss,gradientsV] = objFunc_nPINN(parametersV,dlX,dlX0BC1,dlU0BC1,dlX0BC2,dlU0BC2,dlXTest,UTest,...
    parameterNames,parameterSizes,E,A,L,g,scaleX,scaleU,alpha)
...
[gradients,loss] = dlfeval(@modelGradients_AxialBar_nPINN,parameters,dlX,dlX0BC1,dlU0BC1,dlX0BC2,dlU0BC2,E,A,L,g,scaleX,scaleU,alpha);
