%% Main function for implementing PINN to solve compressed-bar problem by Adam optimizer
...
accfun = dlaccelerate(@modelGradients_AxialBar_PINN_Adam);
% accfun = @modelGradients_AxialBar_PINN_Adam;
...
for epoch = 1:numEpochs
    ...
    while hasdata(mbq)
        ...
        [gradients,loss(iteration,i),lossF(iteration,i),lossUBC1(iteration,i),lossUBC2(iteration,i)] = ...
            dlfeval(accfun,parameters,dlX,dlX0BC1,dlU0BC1,dlX0BC2,dlU0BC2,E,A,L,g);
...
%% Save results
save problemInfo.mat E A L g P numLayers numNeurons numIntColPoints
save resultsAdam_PINN.mat parameters loss lossF lossUBC1 lossUBC2 err TestErr_Adam D meanErr stdErr